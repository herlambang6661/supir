...
class HomeModel extends CI_Model
{
    ...
    var $column_order2 = array('sp.tanggal', 'sp.nopol', 'sp.driver'); //set column field database for datatable orderable
    var $column_search2 = array('sp.tanggal', 'sp.nopol', 'sp.driver'); //set column field database for datatable searchable
